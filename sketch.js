...
function preload() {
  ...
  playerAvatar = new Avatar("Player", 100, 150, 'assets/avatar1.png', 'assets/avatar4.png');
  playerAvatar.setMaxSpeed(5);
  playerAvatar.addStandingAnimation('assets/standing1.png', 'assets/standing4.png')
}
